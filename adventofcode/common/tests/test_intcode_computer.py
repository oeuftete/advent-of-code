...
@pytest.mark.parametrize("opcodes", [[3, 0, 0, 0, 99], [1, 1, 1, 4, 99, 5, 6, 0, 0],])
...
@pytest.mark.parametrize("opcodes", [[], [3, 0, 0, 0], [1, 1, 1, 4, 99, 5, 6, 0],])
...
@pytest.mark.parametrize(
    "opcodes,input_data,last_output",
    [
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                int(i)
                for i in "109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99".split(
                    ","
                )
            ],
        ),
