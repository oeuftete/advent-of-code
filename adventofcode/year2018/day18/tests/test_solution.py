...
from adventofcode.year2018.day18.solution import (Lumberyard, LUMBERYARD,
                                                  OPEN_SPACE, TREES)
...
@pytest.mark.parametrize("x,y,s,empty,tree,yard", [
...
@pytest.mark.parametrize("x,y,s,empty,tree,yard,i", [
