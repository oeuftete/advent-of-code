...
from adventofcode.year2018.day6.solution import (
    get_bound_indices,
    get_boundaries,
...
TEST_COORDINATES = list(
    map(lambda c: Coordinate(csv=c), ["1, 1", "1, 6", "8, 3", "3, 4", "5, 5", "8, 9",])
)


@pytest.mark.parametrize(
    "coordinates,boundaries", [(TEST_COORDINATES, ((1, 8), (1, 9))),]
)
