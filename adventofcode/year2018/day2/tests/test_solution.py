...
SAMPLE_BOXES = ["abcdef", "bababc", "abbcde", "abcccd", "aabcdd", "abcdee", "ababab"]


@pytest.mark.parametrize("box_ids,checksum", [(SAMPLE_BOXES, 12),])
