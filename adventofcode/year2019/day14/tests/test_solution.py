...
@pytest.mark.slow
@pytest.mark.xfail
def test_reaction_four(reaction_four):
    factory = Nanofactory(reaction_four)
    assert factory.minimum_ore == 180697


@pytest.mark.slow
@pytest.mark.xfail
def test_reaction_five(reaction_five):
    factory = Nanofactory(reaction_five)
    assert factory.minimum_ore == 2210736
